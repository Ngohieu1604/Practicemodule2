...
import controller.ProductManagent;
...
public class Main {
    static ProductManagent productManager = new ProductManagent();
    static ReadWrite readWrite = ReadWriteData.getInstance();
    ...
    public static void menuOfProduct() {
        try {
            do {
                ...
                System.out.println("---- Chương Trình Sản Phẩm Bánh Hạt Dẻ ----");
                System.out.println("Chọn chức năng theo số (để tiếp tục)");
                System.out.println("1. Xem danh sách bánh");
                System.out.println("2. Thêm bánh mới");
                System.out.println("3. Cập nhật bánh");
